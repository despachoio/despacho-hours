  ...
  return <main className="min-h-screen bg-[#F8FAFC] px-5 py-7 sm:px-8">
    <div className="mx-auto max-w-[1500px]">
      <header className="relative min-h-[250px] overflow-hidden rounded-[2rem] bg-gradient-to-r from-[#0F172A] via-[#172554] to-[#153E90] px-8 py-10 text-white shadow-xl shadow-slate-300/50 lg:px-12">
        ...
        <div className="relative flex min-h-[170px] flex-col justify-between gap-8 sm:flex-row sm:items-end"><div><p className="text-xs font-bold uppercase tracking-[.24em] text-cyan-200">People & wellbeing</p><h1 className="mt-2 text-4xl font-bold tracking-tight lg:text-5xl">Time Off</h1><p className="mt-3 max-w-2xl text-sm leading-6 text-blue-100">Plan leave, protect team capacity, and keep every policy decision clear and auditable.</p></div><span className="inline-flex w-fit rounded-2xl border border-white/10 bg-white/10 px-5 py-3 text-[10px] font-bold uppercase tracking-[0.18em] text-cyan-200 backdrop-blur">{role || "employee"} experience</span></div>
      </header>
