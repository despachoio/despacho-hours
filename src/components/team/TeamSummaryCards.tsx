...
export default function TeamSummaryCards({
  ...
  const visualTones = [
    { accent: "from-[#153E90] to-cyan-400", surface: "from-white via-white to-blue-50/80" },
    { accent: "from-emerald-600 to-teal-300", surface: "from-white via-white to-emerald-50/80" },
    { accent: "from-violet-600 to-fuchsia-300", surface: "from-white via-white to-violet-50/75" },
    { accent: "from-cyan-600 to-sky-300", surface: "from-white via-white to-cyan-50/75" },
    { accent: "from-amber-500 to-orange-300", surface: "from-white via-white to-amber-50/70" },
    { accent: "from-indigo-600 to-blue-300", surface: "from-white via-white to-indigo-50/70" },
    { accent: "from-rose-600 to-pink-300", surface: "from-white via-white to-rose-50/70" },
  ] as const;
  return (
    <section
