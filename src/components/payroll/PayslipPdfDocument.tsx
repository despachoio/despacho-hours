...
const styles = StyleSheet.create({
  ...
  title: { fontSize: 22.4, fontWeight: "bold", color: PRIMARY, letterSpacing: 0.35 },
  ...
  netItem: { width: "38%", justifyContent: "center", paddingLeft: 21, backgroundColor: PRIMARY, borderRadius: 8 },
