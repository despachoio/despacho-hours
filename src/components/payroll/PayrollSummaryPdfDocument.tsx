...
export function PayrollSummaryPdfDocument({ summary, financialYear, fromMonth, toMonth }: { summary: PayrollSummary; financialYear: string; fromMonth: string; toMonth: string }) {
  const rows: Array<[string, number]> = [
    ...
    ["Gross Pay", summary.grossSalary], ["Employee PF", summary.employeePf], ["Employer PF", summary.employerPf],
    ["Employer EPS", summary.employerEps], ["Administration Charges", summary.administrationCharges],
    ["EDLI Charges", summary.edliCharges], ["Total PF Amount", summary.totalPf],
    ["Professional Tax", summary.professionalTax], ["LOP", summary.lop],
