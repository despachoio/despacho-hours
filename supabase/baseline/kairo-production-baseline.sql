...
CREATE POLICY "Authenticated users can delete active timers" ON "public"."active_timers" FOR DELETE TO "authenticated" USING (true);



CREATE POLICY "Authenticated users can delete client contacts" ON "public"."client_contacts" FOR DELETE TO "authenticated" USING (true);
...
CREATE POLICY "Authenticated users can delete project resources" ON "public"."project_resources" FOR DELETE TO "authenticated" USING (true);
...
CREATE POLICY "Authenticated users can insert active timers" ON "public"."active_timers" FOR INSERT TO "authenticated" WITH CHECK (true);



CREATE POLICY "Authenticated users can insert client contacts" ON "public"."client_contacts" FOR INSERT TO "authenticated" WITH CHECK (true);
...
CREATE POLICY "Authenticated users can insert project resources" ON "public"."project_resources" FOR INSERT TO "authenticated" WITH CHECK (true);
...
CREATE POLICY "Authenticated users can insert time entries" ON "public"."time_entries" FOR INSERT TO "authenticated" WITH CHECK (true);



CREATE POLICY "Authenticated users can read active timers" ON "public"."active_timers" FOR SELECT TO "authenticated" USING (true);



CREATE POLICY "Authenticated users can read client contacts" ON "public"."client_contacts" FOR SELECT TO "authenticated" USING (true);
...
CREATE POLICY "Authenticated users can read project resources" ON "public"."project_resources" FOR SELECT TO "authenticated" USING (true);
...
CREATE POLICY "Authenticated users can update active timers" ON "public"."active_timers" FOR UPDATE TO "authenticated" USING (true);



CREATE POLICY "Authenticated users can update client contacts" ON "public"."client_contacts" FOR UPDATE TO "authenticated" USING (true);
...
CREATE POLICY "Authenticated users can update time entries" ON "public"."time_entries" FOR UPDATE TO "authenticated" USING (true);
...
GRANT ALL ON FUNCTION "public"."enforce_invoice_reminder_status"() TO "anon";
GRANT ALL ON FUNCTION "public"."enforce_invoice_reminder_status"() TO "authenticated";
GRANT ALL ON FUNCTION "public"."enforce_invoice_reminder_status"() TO "service_role";



GRANT ALL ON FUNCTION "public"."get_invoice_dashboard_dimensions"() TO "anon";
GRANT ALL ON FUNCTION "public"."get_invoice_dashboard_dimensions"() TO "authenticated";
GRANT ALL ON FUNCTION "public"."get_invoice_dashboard_dimensions"() TO "service_role";



GRANT ALL ON FUNCTION "public"."get_invoice_kpi_summary"("p_year" integer) TO "anon";
GRANT ALL ON FUNCTION "public"."get_invoice_kpi_summary"("p_year" integer) TO "authenticated";
GRANT ALL ON FUNCTION "public"."get_invoice_kpi_summary"("p_year" integer) TO "service_role";



GRANT ALL ON FUNCTION "public"."get_invoice_monthly_summary"("p_year" integer, "p_currency" "text") TO "anon";
GRANT ALL ON FUNCTION "public"."get_invoice_monthly_summary"("p_year" integer, "p_currency" "text") TO "authenticated";
GRANT ALL ON FUNCTION "public"."get_invoice_monthly_summary"("p_year" integer, "p_currency" "text") TO "service_role";
...
GRANT ALL ON FUNCTION "public"."handle_new_project_wallet"() TO "anon";
GRANT ALL ON FUNCTION "public"."handle_new_project_wallet"() TO "authenticated";
GRANT ALL ON FUNCTION "public"."handle_new_project_wallet"() TO "service_role";



GRANT ALL ON FUNCTION "public"."handle_time_entry_wallet"() TO "anon";
GRANT ALL ON FUNCTION "public"."handle_time_entry_wallet"() TO "authenticated";
GRANT ALL ON FUNCTION "public"."handle_time_entry_wallet"() TO "service_role";



GRANT ALL ON FUNCTION "public"."handle_wallet_transaction_change"() TO "anon";
GRANT ALL ON FUNCTION "public"."handle_wallet_transaction_change"() TO "authenticated";
GRANT ALL ON FUNCTION "public"."handle_wallet_transaction_change"() TO "service_role";
...
GRANT ALL ON FUNCTION "public"."record_invoice_payment"("p_invoice_id" "uuid", "p_amount" numeric, "p_payment_date" "date", "p_payment_method" "text", "p_reference_number" "text", "p_notes" "text", "p_created_by" "uuid") TO "anon";
...
GRANT ALL ON FUNCTION "public"."record_stripe_invoice_payment"("p_invoice_id" "uuid", "p_amount" numeric, "p_currency" "text", "p_payment_intent_id" "text", "p_charge_id" "text", "p_customer_id" "text", "p_payment_method_id" "text", "p_source" "text") TO "service_role";
...
GRANT ALL ON FUNCTION "public"."reverse_invoice_payment"("p_invoice_id" "uuid", "p_reason" "text", "p_notes" "text", "p_reversed_by" "uuid") TO "service_role";
...
GRANT ALL ON FUNCTION "public"."save_client_contact"("p_contact_id" "uuid", "p_client_id" "uuid", "p_first_name" "text", "p_last_name" "text", "p_job_title" "text", "p_email" "text", "p_phone" "text", "p_contact_type" "text", "p_is_primary" boolean) TO "anon";
GRANT ALL ON FUNCTION "public"."save_client_contact"("p_contact_id" "uuid", "p_client_id" "uuid", "p_first_name" "text", "p_last_name" "text", "p_job_title" "text", "p_email" "text", "p_phone" "text", "p_contact_type" "text", "p_is_primary" boolean) TO "authenticated";
GRANT ALL ON FUNCTION "public"."save_client_contact"("p_contact_id" "uuid", "p_client_id" "uuid", "p_first_name" "text", "p_last_name" "text", "p_job_title" "text", "p_email" "text", "p_phone" "text", "p_contact_type" "text", "p_is_primary" boolean) TO "service_role";



GRANT ALL ON FUNCTION "public"."set_client_contact_updated_at"() TO "anon";
GRANT ALL ON FUNCTION "public"."set_client_contact_updated_at"() TO "authenticated";
GRANT ALL ON FUNCTION "public"."set_client_contact_updated_at"() TO "service_role";



GRANT ALL ON FUNCTION "public"."set_company_settings_updated_at"() TO "anon";
GRANT ALL ON FUNCTION "public"."set_company_settings_updated_at"() TO "authenticated";
GRANT ALL ON FUNCTION "public"."set_company_settings_updated_at"() TO "service_role";



GRANT ALL ON FUNCTION "public"."set_recurring_updated_at"() TO "anon";
GRANT ALL ON FUNCTION "public"."set_recurring_updated_at"() TO "authenticated";
GRANT ALL ON FUNCTION "public"."set_recurring_updated_at"() TO "service_role";



GRANT ALL ON FUNCTION "public"."sync_project_wallet"("target_project_id" "uuid") TO "anon";
GRANT ALL ON FUNCTION "public"."sync_project_wallet"("target_project_id" "uuid") TO "authenticated";
GRANT ALL ON FUNCTION "public"."sync_project_wallet"("target_project_id" "uuid") TO "service_role";
...
GRANT ALL ON TABLE "public"."project_hour_wallets" TO "anon";
GRANT ALL ON TABLE "public"."project_hour_wallets" TO "authenticated";
GRANT ALL ON TABLE "public"."project_hour_wallets" TO "service_role";
